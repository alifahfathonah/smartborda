<div class="row">
   <div class="col-lg-12">
      <hr class="border border-secondary mb-1 mt-1">
      <strong class="card-title"><?= $smart ?></strong>
      <hr class="border border-secondary mb-0 mt-1">
      ...
      <div class="table-stats order-table ov-h">
         <table class="table table-bordered table-striped">
            ...
            $sql = "SELECT nama_sm,point,penilaian.id_sm, sum(utinor) as smart FROM `penilaian` INNER join m_sosokmulia on penilaian.id_sm=m_sosokmulia.id_sm WHERE id_user='$iduser' and penilaian.id_periode='$idperiode' and point is not null group by penilaian.id_sm";
            ...
            foreach ($sosokmulia as $sm) : ?>
               <tr align="center">
                  ...
                  <?php foreach ($kriteria as $kr) :
                     ...
                     <?php endforeach ?>
                  <?php endforeach ?>
                  <td style="background-color: #cff7d6"><?= number_format($sm['smart'], 2) ?>
                  </td>
               </tr>
            <?php endforeach ?>
         </table>
