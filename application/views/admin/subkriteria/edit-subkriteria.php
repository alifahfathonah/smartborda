      ...
      <div class="col-lg-6">
         <div class="card">
            ...
            <div class="card-body">
               ...
               <div id="pay-invoice">
                  <div class="card-body">
                     <form action="<?= base_url('subkriteria/ubah/' . $dt['id_subkriteria'] . '') ?>" method="post">
                        <div class="form-group">
                           <label for="namaSubKriteria" class="control-label mb-1">Nama Sub Kriteria</label>
                           <input id="namaSubKriteria" name="namaSubKriteria" type="text" class="form-control" value="<?= $dt['subkriteria'] ?>">
                           <?= form_error('namaSubKriteria', '<label class="error text-danger">', '</label>') ?>
                        </div>
                        <div class="form-group has-success">
                           <label for="nilai" class="control-label mb-1">Nilai</label>
                           <input id="nilai" name="nilai" type="text" class="form-control" value="<?= $dt['nilai'] ?>">
                        ...
                        <div class="form-group">
                           ...
                           <select name="idKriteria" id="select" class="form-control">
                              <?php foreach ($kriteria as $kri) : ?>
                                 <option value="<?= $kri['id_kriteria'] ?>" <?= $dt['id_kriteria'] == $kri['id_kriteria'] ? 'selected' : '' ?>><?= $kri['kriteria'] . ' [' . $kri['kd_kriteria'] . ']' ?></option>
                              <?php endforeach ?>
                           </select>
                        </div>
