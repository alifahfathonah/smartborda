 ...
 <script>
    function validate() {
       if (document.getElementById('validasi').checked) {
          $("#simpan-button").removeAttr('disabled');
       } else {
          $("#simpan-button").attr('disabled', true);
       }
    }
    ...
    function disableInputPassword() {
       if (document.getElementById('passDefault').checked) {
    ...
    function disableInputPasswordTambah() {
       if (document.getElementById('passDefaultTambah').checked) {
          $("#passwordTambah").attr('disabled', true);
       } else {
          $("#passwordTambah").removeAttr('disabled');
       }
    }

    function ubahPassword() {
       if (document.getElementById('ubahPass').checked) {
          $("#ubahPasswordForm").removeAttr('hidden');
       } else {
          $("#ubahPasswordForm").attr('hidden', true);
       }
    }
    ...
    function startTime() {
       ...
       m = checkTime(m);
       s = checkTime(s);
       document.getElementById('jamHeader').innerHTML =
          h + ":" + m + ":" + s;
